...
const AdminAuth = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-600 overflow-hidden"
    >
      ...
      <div
        className="w-full max-w-md p-10 rounded-3xl shadow-2xl relative z-10"
        style={{
...
/>
  ...
  Digital Service Centre
        ...
        <button
          ...
          disabled={loading}
          style={{ boxShadow: '0 6px 24px 0 rgba(0, 118, 255, 0.25)' }}
        >
          {loading ? (
